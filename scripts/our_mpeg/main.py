...
from our_mpeg import compute_dual_reference, apply_dual_reference
...
def compress_image_with_dual_reference(im1, reference_image1, reference_image2):
    im1_blocks = break_blocks(im1)
    im1_offsets, im1_residuals = compute_dual_reference(im1_blocks, reference_image1, reference_image2)
    im1_residuals_dct = transform(im1_residuals)
    im1_residuals_q = quantize(im1_residuals_dct)
    return im1_offsets, im1_residuals_q
